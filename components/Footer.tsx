...
export default function Footer() {
  ...
  return (
    <footer style={{ backgroundColor: '#466D7A' }} className="text-white/88">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-sm leading-relaxed max-w-sm text-white/85">
            ...
            <div className="mt-5 flex items-center gap-3">
              <a href="https://www.facebook.com/Janarealestatee/" target="_blank" rel="noopener noreferrer"
                ...
                style={{ backgroundColor: 'rgba(255,255,255,0.22)' }} aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/jana.realestatepr/" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:opacity-80"
                style={{ backgroundColor: 'rgba(255,255,255,0.22)' }} aria-label="Instagram">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.youtube.com/@janarealestate" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:opacity-80"
                style={{ backgroundColor: 'rgba(255,255,255,0.22)' }} aria-label="YouTube">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 pt-8 border-t space-y-2" style={{ borderColor: 'rgba(255,255,255,0.22)' }}>
