...
export default function PropertyCard({ property }: { property: Property }) {
  ...
  const isLand = property.propertyType === 'land' || property.bedrooms === 0
    ...
    <Link href={`/properties/${property.id}`} className="group block">
      ...
      >
        ...
        <div className="relative h-56 overflow-hidden bg-slate-100">
          ...
          <span
            className="absolute top-3 right-3 text-xs font-semibold px-3 py-1.5 rounded-full capitalize"
            style={{ backgroundColor: 'white', color: '#466D7A' }}
          >
        ...
        {/* Content */}
        <div className="p-5">
          <p className="text-2xl font-bold" style={{ color: '#EF8853' }}>
            {formatPrice(property.price)}
          </p>
          <h3
            className="mt-1 text-base font-semibold line-clamp-2 transition-colors"
            style={{ color: '#466D7A' }}
          >
            {property.title}
          </h3>
